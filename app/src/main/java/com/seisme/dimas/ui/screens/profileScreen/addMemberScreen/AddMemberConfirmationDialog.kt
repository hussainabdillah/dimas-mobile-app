...
@Composable
fun AddMemberConfirmationDialog(
    onDismiss: () -> Unit,
    onConfirmAddMember: () -> Unit
) {
    AlertDialog(
        onDismissRequest = onDismiss,
        title = { Text(
            text = stringResource(R.string.add_member_confirm),
            color = Color.Black,
        ...
        text = { Text(
            text = stringResource(R.string.add_member_confirmation),
            color = Color.Black,
